#this script trains simple classification algorithm using pre-tagged content. It was developed to help classify feedback gathered on the Canada.ca website. It allows several models to be trained, depending on the topic of the page the feedback was gathered from - each entry needs to have a model assigned to it.
